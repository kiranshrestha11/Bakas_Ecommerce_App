...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        "https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyBJEEJiGECd6o5l5mFjTYlocBwolVd0z_o";
    try {
      ...
      if (urlSegment == "signUp") {
        ...
        userType = await getUser(_token, userId);
      }
      _autoLogout();
      notifyListeners();
  ...
  Future<String> addUserToDatabase(
    ...
    final url =
        "https://baakas-ddd52.firebaseio.com/users/$userId.json?auth=$authToken";
    try {
